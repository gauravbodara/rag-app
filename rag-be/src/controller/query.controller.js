...
const handleQuery = async (req, res) => {
  ...
  try {
    ...
    logger.info(`Query embedding/vector search time: ${embeddingEnd - embeddingStart}ms`);
    embeddingSpan.log({ event: 'query_vector_time', value: embeddingEnd - embeddingStart });
    ...
    const answer = await callLLMWithContext(query, context, process.env.OPENAI_API_KEY, parentSpan);
